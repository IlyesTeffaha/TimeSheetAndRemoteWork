...
import { selectTodos,getTodos,selectTodosById } from './store/todosSlice';
import TodoListItem from './TodoListItem';

function TodoList(props) {
  const todos = useSelector(selectTodos);
  localStorage.setItem("todos ",todos.name );
  const ids= useSelector(({ todoApp }) => todoApp.todos.id);
